...
pub mod declarative {
    pub use patchbay_gui::{
        ...
        CurveEditorSpec, CurveEditorStyle, CurveHighlightMode, CurveInteractionOptions, CurveModel,
        CurvePoint, CurveSegment, DeclarativeError, DropdownSpec, EdgeInsets, EndpointMode,
        FlexSpec, GridKind, GridSpec, GridTemplate, IndicatorSpec, Justify, KnobSpec, LayoutBox,
        ...
        RenderResult, RootFrameSpec, RootScaleMode, ScrollViewSpec, SliderSpec, Slot, SlotAlign,
        ...
        WeightedSlot, WrapSpec, button, column, column_slots, curve_editor, dropdown, fill_slot,
        fraction_slot, grid, indicator, knob, measure_checked, panel, region, render_checked,
