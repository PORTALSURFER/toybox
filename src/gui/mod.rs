...
pub mod declarative {
    pub use patchbay_gui::{
        ...
        UiAction, UiSpec, WeightedSlot, WrapSpec, button, column, column_slots, dropdown,
        fill_slot, fraction_slot, grid, indicator, knob, label, measure_checked, panel, region,
