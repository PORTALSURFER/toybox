...
- external `LayoutBox` struct-literal construction removed; builder-only layout authoring enforced
...
- No additional structural gaps are currently tracked in this milestone set.
